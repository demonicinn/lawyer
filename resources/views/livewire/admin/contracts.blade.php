<div>
        ...
        <table style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="edit-icons" href="javascript::void(0)" wire:click="edit('{{$contract->id}}')"><i class="fas fa-pen"></i></a>
                        <a class="view-icon" href="javascript::void(0)" wire:click="delete('{{$contract->id}}')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div wire:ignore.self class="modal fade" id="contractForm" tabindex="-1" aria-labelledby="contractForm" aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            window.livewire.on('contractFormClose', () => {
                $('#contractForm').modal('hide');
            });
            window.livewire.on('contractFormShow', () => {
